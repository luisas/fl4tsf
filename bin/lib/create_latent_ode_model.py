...
def create_LatentODE_model(latents, poisson, units, gen_layers, rec_dims, rec_layers, 
                          ...
                          solver_method='tsit5', encoder_solver_method='euler',
    ...
    if poisson:
        ...
        ode_func_net = utils.create_net(dim, latents, 
            n_layers=gen_layers, n_units=units, nonlinear=nn.LeakyReLU)
    ...
    if z0_encoder == "odernn":
        ...
        z0_diffeq_solver = DiffeqSolver(
            ...
            odeint_rtol=1e-3, odeint_atol=1e-3, device=device)
    ...
    diffeq_solver = DiffeqSolver(
        ...
        odeint_rtol=1e-5, odeint_atol=1e-7, device=device)  # Tighter tolerances
