# bin/lib/latent_ode.py - Clean LatentODE class leveraging inheritance
...
class LatentODE(VAE_Baseline):
    ...
    def _compile_methods(self):
        ...
        try:
            print("TorchODE solvers are natively JIT-compatible")
            self.use_jit = True
        except Exception as e:
            print(f"Warning: JIT compilation setup failed: {e}")
            self.use_jit = False
    ...
    def get_reconstruction(self, time_steps_to_predict, truth, truth_time_steps, 
        ...
        """Get reconstruction of the time series - ODE-specific implementation"""
        ...
        if self.use_poisson_proc:
            ...
            # append a vector of zeros to compute the integral of lambda and intialize lambda(t0)=0
    ...
    def sample_traj_from_prior(self, time_steps_to_predict, n_traj_samples=1):
        """Sample trajectory from prior - ODE-specific implementation"""
